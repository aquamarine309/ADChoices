...
export const GameStorage = {
  ...
  get localStorageKey() {
    return DEV ? "dimensionChoiceTestSave" : "dimensionChoiceSave";
  },

  backupDataKey(saveSlot, backupSlot) {
    return DEV ? `backupChoiceTestSave-${saveSlot}-${backupSlot}` : `backupChoiceSave-${saveSlot}-${backupSlot}`;
  },

  backupTimeKey(saveSlot) {
    return DEV ? `backupChoiceTestTimes-${saveSlot}` : `backupChoiceTimes-${saveSlot}`;
  },
